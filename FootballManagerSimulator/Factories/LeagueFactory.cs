...
public class LeagueFactory : ICompetitionFactory
{
    ...
    public ICompetition CreateCompetition(Competition competition)
    {
        ...
        league.Fixtures = GenerateNextRoundOfFixtures(clubs.ToList(), league);
        return league;
    }
    ...
    public List<Fixture> GenerateNextRoundOfFixtures(List<Club> clubs, League league)
    {
        ...
        for (var round = 0; round < numRounds; round++)
        {
            ...
            {
                HomeClub = Utils.GetClub(clubs[0].ID),
        ...
        for (var round = 0; round < numRounds; round++)
        {
            ...
            output.Add(new Fixture
            {
                ...
                AwayClub = Utils.GetClub(clubs[0].ID),
